...
class Config:
    ...
    min_step_margin: float = 0.4  # Minimum avg q value margin for preference pairs
    ...
    round_number: int = 6  # "rStar-Math round number"
    ...
    def __post_init__(self):
        ...
        if self.execute_in_subprocess:
            os.environ["RSTAR_SUBPROCESS_EXECUTION"] = "1"
        else:
            os.environ["RSTAR_SUBPROCESS_EXECUTION"] = "0"
