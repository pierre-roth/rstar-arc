...
echo "Running: python merge_lora.py" | tee -a "${local_job_dir}/job_info.log"
...
python merge_lora.py > "${local_job_dir}/program_output.log" 2> "${local_job_dir}/program_error.log"
EXIT_CODE=$?
