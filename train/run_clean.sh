...
echo "Running: python clean_sft_data.py" | tee -a "${local_job_dir}/job_info.log"
...
python clean_sft_data.py > "${local_job_dir}/program_output.log" 2> "${local_job_dir}/program_error.log"
EXIT_CODE=$?
