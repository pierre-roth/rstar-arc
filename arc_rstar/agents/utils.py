...
from arc_rstar.prompts.prompt_rstar import PROMPT_RSTAR
from arc_rstar.tools.python_tool import PythonInterpreter
from arc_rstar.constants import *
...
def rstar_equiv(gt, pred):
    ...
    try:
        ...
        if any(
                func(x, y) for func in [math_equal, is_equiv, check_one_answer] for x, y in
                [(gt_strip, pred_strip), (pred_strip, gt_strip)]
        ):
            return True
